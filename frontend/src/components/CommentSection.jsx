        ...
        <form onSubmit={handleSubmit} className="mb-4">
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 border border-stone-300 px-3 py-2 text-sm focus:outline-none focus:border-stone-900 transition-colors bg-transparent"
            />
            <button
              type="submit"
              disabled={loading || !text.trim()}
              className="px-4 py-2 bg-stone-900 text-white text-sm hover:bg-stone-700 disabled:opacity-50 transition-colors"
            >
              Post
            </button>
          </div>
