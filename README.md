# PixelShare — Scalable Cloud-Native Photo Sharing Platform
...
PixelShare is a simplified Instagram-style photo sharing web application demonstrating scalable cloud-native architecture principles. Creators upload photos with rich metadata; consumers browse, search, comment, and rate those photos.
...
# Ensure a test PostgreSQL database exists (PixelShare_test) or use the same DB
